...
public class SwaggerConfiguration {
    ...
    public Docket getDocket() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.basePackage("com.GenericApi")).build().apiInfo(apiInfo).useDefaultResponseMessages(false);
    }
}
